...
tokenizer = AutoTokenizer.from_pretrained("google/gemma-2-9b-it", cache_dir="./gemma-2-9b-it-tokenizer")

model = AutoModelForCausalLM.from_pretrained(
    "google/gemma-2-9b-it",
    device_map="auto",
    torch_dtype=torch.bfloat16,
    cache_dir="./gemma-2-9b-it-model").eval()
...
###########################################
out_file = open("./results-gemma_9b-s4.txt", "a", encoding="utf8")
...
for fname in file_names:
    ...
    for line in lines:
        ...
        prompt = line["input"]
        gold_truth = 1 if line["label"] == "Yes." else 0
