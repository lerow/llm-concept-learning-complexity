...
# dev_map = infer_auto_device_map(model, max_memory={0: "42GB", 1: "42GB"})
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    cache_dir="./Qwen2-72B-Instruct-llm_int8-model").eval()



tokenizer = AutoTokenizer.from_pretrained("Qwen/Qwen2-72B-Instruct", cache_dir="Qwen2-72B-Instruct-tokenizer")
